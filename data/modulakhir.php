...
if ($_GET['action'] == 'selesai') {
    ...
    $sql = "INSERT INTO module_learned (module_id, student_id) VALUES(8, '{$s_id}')";
...
if ($_GET['action'] == 'submitPostTest') {
    ...
    if ($presentasi > 0.75) {
        ...
        $sql2 = "INSERT INTO nilai_post_test (student_id, nilai, module_id, status) VALUES('{$s_id}', '{$nilai}', 8,'post test final')";
