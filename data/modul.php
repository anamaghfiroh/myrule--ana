...
if ($_GET['action'] == 'selesai') {
    ...
    $sql = "INSERT INTO module_learned (module_id, student_id,status_modul) VALUES('{$m_id}', '{$s_id}','adaptive learning')";
...
if ($_GET['action'] == 'submitPostTest') {
    ...
    if ($presentasi > 0.75) {
        ...
        $sql2 = "INSERT INTO nilai_post_test (student_id, nilai, module_id, status) VALUES('{$s_id}', '{$nilai}', '{$m_id}','adaptive learning')";
        ...
        $s_id = mysqli_real_escape_string($conn, $_SESSION['student_id']);
        $m_id = mysqli_real_escape_string($conn, $_POST['module']);
        $sql2 = "INSERT INTO nilai_post_test (student_id, nilai, module_id, status) VALUES('{$s_id}', '{$nilai}', '{$m_id}','adaptive learining')";
        $query2 = mysqli_query($conn, $sql2);
        header("location: ../student/modul.php");
    }
}