...
$sql2 = "SELECT * from module where id = '{$modul}'";
$query2 = mysqli_query($conn, $sql2);
$modul2 = mysqli_fetch_array($query2, MYSQLI_ASSOC);
?>
        ...
        <div class="main px-lg-4 px-md-4">
            ...
            <div class="body d-flex py-lg-2 py-md-2">
                <div class="container-fluid">
                    <h2><?php echo $modul2['module_desc'] ?></h2>
                                ...
                                <div class="col-12 col-xl-12 col-lg-12">
                                    <div class="card mb-3 bg-info">
                                        <div class="card-body p-5">
                                            ...
                                            <div class="col mt-3">
                                                <a href="post_test_elearn.php?module=<?php echo $_GET['module'] ?>"
