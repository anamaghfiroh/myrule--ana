...
<body>
    ...
    $(document).ready(function() {
        table = $('#topikTable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "../data/materi.php?action=getModulPostTest",
                "dataType": "json",
                "type": "POST",
            },
        ...
        $('#topikTable').on('click', '#btn-edit', function() {
            $.ajax({
                url: "../data/materi.php?action=getPostTestById",
                method: "post",
                type: "ajax",
                data: {
                    id: $(this).attr('data'),
                ...
                success: function(data) {
                    ...
                    $('#idPostTest').val(data['id']);
                },
                error: function(e) {
                    console.log(e);
                }
            })
            $('#modalEditPostTest').modal('show');
        })
    });
    </script>
</body>
