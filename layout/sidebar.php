    ...
    <div class="d-flex flex-column h-100">
        ...
        <ul class="menu-list flex-grow-1 mt-3">
            ...
            <li class="collapsed"><a class="m-link" data-bs-toggle="collapse" data-bs-target="#corses-Components"
                    href="#"><i class="icofont-law-document"></i> <span>Post Test</span><span
                        class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                <ul class="sub-menu collapse" id="corses-Components">
                    <li><a class="ms-link" href="post-test.php"><span>Post Test</span></a></li>
                    <li><a class="ms-link" href="hasil-post-test.php"><span>Hasil Post Test</span></a></li>
                </ul>
            </li>
            <?php } ?>
            ...
            <li><a class="m-link" href="modul.php"><i class="icofont-certificate"></i> <span>Adaptive Learning Modul</span></a></li>
            <li><a class="m-link" href="elearn.php"><i class="icofont-certificate"></i> <span>E Learning Modul</span></a></li>
            <?php } ?>
        </ul>
